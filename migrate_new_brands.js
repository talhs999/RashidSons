...
dbData.brands = finalBrands;

fs.writeFileSync(dbPath, JSON.stringify(dbData, null, 2));

// Also generate a new version of the brands array for lib/data.ts replacement
const tsDataPath = 'C:\\jrashid\\lib\\brands_export.ts.txt';
fs.writeFileSync(tsDataPath, `export const brands: Brand[] = ${JSON.stringify(finalBrands, null, 2)};`);

console.log("Database updated with the 6 final brands.");

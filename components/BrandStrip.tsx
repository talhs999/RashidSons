...
const brands = [
  ...
  },
  {
    name: "Warrior",
    slug: "warrior",
    logo: "/images/brands/warrior-final-black.png",
    tire: "/images/tires/advan-neova-ad09.webp",
  },
  {
    name: "Atlas Tyre",
    slug: "atlas",
    logo: "/images/brands/atlas-logo.png",
    tire: "/images/tires/advan-apex.png",
  },
  {
    name: "Risen",
    slug: "risen",
    logo: "/images/brands/risen-logo.png",
    tire: "/images/tires/advan-a055.webp",
  },
  {
    name: "Falken",
    slug: "falken",
    logo: "/images/brands/falken-logo.png",
            ...
            >
              ...
              >
                ...
                <div className="flex flex-col items-center justify-between w-full h-full group-hover:opacity-0 group-hover:scale-95 transition-all duration-500">
                  ...
                  {/* Bottom: Brand Logo */}
                  <div className="relative w-full h-[85px] flex items-center justify-center border-t border-gray-100 pt-3">
                    <img
                      src={brand.logo}
                      alt={brand.name}
